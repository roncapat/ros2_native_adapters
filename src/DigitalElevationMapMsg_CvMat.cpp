...
{
  RCLCPP_DEBUG(rclcpp::get_logger("Digital Elevation Map Adapter"), "Copy constructor called");
...
{
  RCLCPP_DEBUG(rclcpp::get_logger("Digital Elevation Map Adapter"), "Move constructor called");
...
StampedDigitalElevationMap_CV & StampedDigitalElevationMap_CV::operator=(
  const StampedDigitalElevationMap_CV & other)
{
  RCLCPP_DEBUG(rclcpp::get_logger("Digital Elevation Map Adapter"), "Assignment operator called");
...
{
  RCLCPP_DEBUG(rclcpp::get_logger("Digital Elevation Map Adapter"), "Conversion to message");
...
{
  RCLCPP_DEBUG(rclcpp::get_logger("Digital Elevation Map Adapter"), "Conversion from message");
  destination.mat =
