...
{
  RCLCPP_DEBUG(rclcpp::get_logger("PointCloud2 Adapter"), "Copy constructor called");
  // raise(SIGTRAP);
...
{
  RCLCPP_DEBUG(rclcpp::get_logger("PointCloud2 Adapter"), "Move constructor called");
  // raise(SIGTRAP);
...
{
  RCLCPP_DEBUG(rclcpp::get_logger("PointCloud2 Adapter"), "Assignment operator called");
  // raise(SIGTRAP);
...
{
  RCLCPP_DEBUG(rclcpp::get_logger("PointCloud2 Adapter"), "Conversion to message");
  // raise(SIGTRAP);
...
{
  RCLCPP_DEBUG(rclcpp::get_logger("PointCloud2 Adapter"), "Conversion from message");
  // raise(SIGTRAP);
  bool rgb = false;
  bool rgba = false;
